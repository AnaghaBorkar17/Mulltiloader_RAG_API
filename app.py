...
class SQLRequest(BaseModel):
    database_url: str = Field(
        ...,
        description="SQLAlchemy database URL or SQLite path (use forward slashes or sqlite:/// prefix)",
        json_schema_extra={
            "example": "sqlite:///C:/Users/HP/Downloads/sample_database.db"
        }
    )
    query: str = Field(
        ...,
...
async def upload_files(
    ...
    # If all files failed, return 400 with details
